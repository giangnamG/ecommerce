                ...
                <ul class="tabs md-margin-bottom-35-im xs-margin-bottom-40-im">
                    <li class="tab-element active">
                        <a href="#tab01_1st" class="tab-link"><span
                                class="biolife-icon icon-lemon"></span><?php echo $array_collum['0']; ?></a>
                    </li>
                    <li class="tab-element">
                        <a href="#tab01_2nd" class="tab-link"><span
                                class="biolife-icon icon-grape2"></span></span><?php echo $array_collum['1']; ?></a>
                    </li>
                    <li class="tab-element">
                        <a href="#tab01_3rd" class="tab-link"><span
                                class="biolife-icon icon-blueberry"></span></span><?php echo $array_collum['2']; ?></a>
                    </li>
                    <li class="tab-element">
                        <a href="#tab01_4th" class="tab-link"><span
                                class="biolife-icon icon-orange"></span></span><?php echo $array_collum['3']; ?></a>
                    </li>
                    <li class="tab-element">
                        <a href="#tab01_5th" class="tab-link"><span
                                class="biolife-icon icon-broccoli"></span></span><?php echo $array_collum['4']; ?></a>
                    </li>
                </ul>
            </div>
                                ...
                                <div class="contain-product layout-default">
                                    ...
                                    <div class="info">
                                        ...
                                        <h4 class="product-title"><a
                                                href="single_product.php?status=singleproduct&&id=<?php echo $eight_pdt['pdt_id'] ?>"
                                                class="pr-name"><?php echo $eight_pdt_ctg_one['pdt_name'] ?></a></h4>
                                        <div class="price ">
                                            <ins><span class="price-amount"><span class="currencySymbol">TK.
